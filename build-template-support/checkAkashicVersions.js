...
targetVersions.forEach(function(version) {
	...
	var inputPackageJson =
		JSON.parse(fs.readFileSync(path.join(__dirname, "..", "templates", "template-export-html-" + version, "package.json"), "utf8"));
	var outputVersionsJson = JSON.parse(fs.readFileSync(path.join(__dirname, "..", "templates-build", version, "js", "versions.json"), "utf8"));
