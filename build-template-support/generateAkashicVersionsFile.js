...
var akashicLibDir = path.resolve(__dirname + "/../templates/template-export-html-" + version + "/node_modules/@akashic");
...
fs.writeFileSync(path.join(__dirname, "..", "templates", "template-export-html-" + version, "js", "versions.json"), JSON.stringify(versions));
